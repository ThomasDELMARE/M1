...
barplot(moyennes, xlab="Age", ylab = "Morts en France en 1900", main="Nombre de morts en 1900 par rapport à leur age", beside=T, args.legend=list(x="topright"))
box()
...
et 1990 par rapport à leur age.", ylab="Nombre de morts", xlab="Age", beside=T,legend.text = c("1900","1990"), col=c("black", "green"), args.legend=list(x="topright"))
box()
